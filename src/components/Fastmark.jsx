...
const Fastmark = () => {
  ...
  // Cerrar slidebar al hacer click afuera
  useEffect(() => {
  ...
  const montoOptions = [
    ...
    ...Array.from(
      new Set(
        data.map((it) => it.monto).filter((v) => v !== "" && v != null)
      )
    )
    ...
    <div className="homepage-container">
      ...
      >
        ...
        <Select
          ...
          onChange={(opts) => setFilters((f) => ({ ...f, direccion: opts || [] }))}
      ...
      {showDireccionAlert &&
        Object.keys(direccionCounts).filter((dir) => direccionCounts[dir] > 1).length > 0 && (
          <div
            style={{
              background: "#fff3cd",
              color: "#856404",
          ...
          >
            ...
            <span style={{ flex: 1 }}>
              <b>¡Atención!</b> Hay direcciones duplicadas en los registros filtrados:
              <ul
                style={{
                  margin: "6px 0 0 18px",
                  fontWeight: "normal",
            ...
            <tbody>
              {currentPageData.length > 0 ? (
                currentPageData.map((item) => {
                  ...
                  return (
                    <tr key={item.id} className={isDireccionDuplicada ? "direccion-duplicada" : ""}>
                      {/* FECHA */}
                      <td>
                        <input
                          type="date"
                      ...
                      <td className="direccion-fixed-td">
                        <div className="custom-select-container">
                          <input
                            ...
                            onBlur={(e) => {
                              ...
                              if (e.target.value !== (item.direccion || "")) {
                                handleFieldChange(item, "direccion", e.target.value);
                              }
                            }}
                          />
                          ...
                          <datalist
                            ...
                            style={{ height: "20px", maxHeight: "20px", overflowY: "auto" }}
                          >
                            {Array.from(
                              new Set(
                                clients
                      ...
                      <td>
                        <input
                          ...
                          onBlur={(e) => {
                            ...
                            if (val !== (item.monto ?? "")) {
                              handleFieldChange(item, "monto", raw);
                            }
                          }}
